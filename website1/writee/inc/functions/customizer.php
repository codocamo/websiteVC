	...
	protected function render_content() {
		...
		if ( ! empty( $this->description ) ) :
			...
			<p style="text-align:center;">
				<a href="<?php echo esc_url('http://www.scissorthemes.com/theme/writee-pro/?ref=wordpress'); ?>" target="_blank" class="button button-primary button-block button-hero WRT-customizer-link WRT-customizer-upgrade"><?php esc_html_e( 'Upgrade To Pro', 'writee' ); ?></a>
			</p>
			<p style="text-align:center;">
				<a href="<?php echo esc_url('http://www.scissorthemes.com/theme/writee'); ?>" target="_blank" class="button button-primary button-block button-hero WRT-customizer-link WRT-customizer-upgrade"><?php esc_html_e( 'Theme Info', 'writee' ); ?></a>
			</p>		
			<p style="text-align:center;">
				<a href="<?php echo esc_url('https://www.scissorthemes.com/doc/writee'); ?>" target="_blank" class="button button-primary button-hero button-block WRT-customizer-link WRT-customizer-upgrade"><?php esc_html_e( 'Documentation', 'writee' ); ?></a>
			</p>
			<p style="text-align:center;">
				<a href="<?php echo esc_url('https://www.scissorthemes.com/support'); ?>" target="_blank" class="button button-primary button-hero button-block WRT-customizer-link WRT-customizer-upgrade"><?php esc_html_e( 'Support', 'writee' ); ?></a>
			</p>
			<p style="text-align:center;">
				<a href="<?php echo esc_url('https://www.scissorthemes.com/demo/index.php?theme=writee'); ?>" target="_blank" class="button button-primary button-hero button-block WRT-customizer-link WRT-customizer-upgrade"><?php esc_html_e( 'View Demo', 'writee' ); ?></a>
			</p>
			<p style="text-align:center;">
				<a href="<?php echo esc_url('https://wordpress.org/support/theme/writee/reviews/#new-post'); ?>" target="_blank" class="button button-primary button-hero button-block WRT-customizer-link WRT-customizer-upgrade"><?php esc_html_e( 'Rate This Theme', 'writee' ); ?></a>
			</p>
			</div>
